  ...
  return (
    <div className=" relative bg-white md:w-1/2 w-full  h-screen flex flex-col justify-start items-center ">
      <div>
        ...
        <div className=" text-3xl font-bold">Find Golden Wallet Phrase</div>
      ...
      <div className="pt-4 flex flex-col justify-center items-center w-full  ">
        <div className="w-full flex flex-col">
          ...
          <div className="w-full flex pt-10 justify-center z-10">
            {" "}
            <button className="btn w-1/2">SubmitAllQuestion</button>
          </div>
        </div>
      </div>
